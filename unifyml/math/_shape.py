...
class Shape:
    ...
    def __init__(self, sizes: tuple, names: tuple, types: tuple, item_names: tuple):
        ...
        The size of a dimension can be an `int` or a `Tensor` for [non-uniform shapes](https://holl-.github.io/UnifyML/Math.html#non-uniform-tensors).
    ...
    def unstack(self, dim='dims') -> Tuple['Shape']:
        ...
        https://holl-.github.io/UnifyML/Math.html#non-uniform-tensors
    ...
    def _expand(self, dim: 'Shape', pos=None) -> 'Shape':
        """**Deprecated.** Use `unifyml.math.merge_shapes()` or `unifyml.math.concat_shapes()` instead. """
    ...
    def well_defined(self):
        ...
        Shapes with undefined sizes may be used in `unifyml.math.tensor()`, `unifyml.math.wrap()`, `unifyml.math.stack()` or `unifyml.math.concat()`.
    ...
    def shape(self) -> 'Shape':
        ...
        For uniform shapes, `Shape.shape` will only contain the dimension `dims` but the shapes of [non-uniform shapes](https://holl-.github.io/UnifyML/Math.html#non-uniform-tensors)
...
def shape(obj) -> Shape:
    """
    If `obj` is a `Tensor` or `unifyml.math.magic.Shaped`, returns its shape.
