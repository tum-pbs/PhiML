...
def choose_backend_t(*values, prefer_default=False) -> Backend:
    ...
    Returns:
        The selected `unifyml.math.backend.Backend`
    """
...
def convert(x, backend: Backend = None, use_dlpack=True):
    """
    Convert the native representation of a `Tensor` or `unifyml.math.magic.PhiTreeNode` to the native format of `backend`.

    *Warning*: This operation breaks the automatic differentiation chain.

    See Also:
        `unifyml.math.backend.convert()`.

    Args:
        x: `Tensor` to convert. If `x` is a `unifyml.math.magic.PhiTreeNode`, its variable attributes are converted.
        backend: Target backend. If `None`, uses the current default backend, see `unifyml.math.backend.default_backend()`.
...
def to_device(value, device: ComputeDevice or str, convert=True, use_dlpack=True):
    ...
    Args:
        value: `Tensor` or `unifyml.math.magic.PhiTreeNode` or native tensor.
...
def native(value: Union[Tensor, Number, tuple, list, Any]):
    ...
    If `value` is a `unifyml.math.Tensor`, this is equal to calling `unifyml.math.Tensor.native()`.
...
def numpy(value: Union[Tensor, Number, tuple, list, Any]):
    ...
    If `value` is a `unifyml.math.Tensor`, this is equal to calling `unifyml.math.Tensor.numpy()`.
...
def reshaped_tensor(value: Any,
    ...
    See Also:
        `unifyml.math.tensor()`, `reshaped_native()`, `unpack_dim()`.
    ...
    Args:
        ...
        *inputs: Uniform `Tensor` arguments
        channels_last: (Optional) Whether to put channels as the last dimension of the native representation.
            ...
            see `unifyml.math.backend.Backend.prefers_channels_last()`.
...
def pad(value: Tensor, widths: Union[dict, tuple], mode: Union['e_.Extrapolation', Tensor, Number] = 0, **kwargs) -> Tensor:
    ...
    Args:
        ...
        kwargs: Additional padding arguments.
            These are ignored by the standard extrapolations defined in `unifyml.math.extrapolation` but can be used to pass additional contextual information to custom extrapolations.
...
def abs_(x) -> Union[Tensor, PhiTreeNode]:
    ...
    *Note*: The gradient of this operation is undefined for *x=0*.
    ...
    Args:
        x: `Tensor` or `unifyml.math.magic.PhiTreeNode`
...
def sign(x) -> Union[Tensor, PhiTreeNode]:
    ...
    Returns:
        `Tensor` or `unifyml.math.magic.PhiTreeNode` matching `x`.
    """
    return _backend_op1(x, Backend.sign)


def round_(x) -> Union[Tensor, PhiTreeNode]:
    """ Rounds the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x` to the closest integer. """
    return _backend_op1(x, Backend.round)


def ceil(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *⌈x⌉* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
...
def sqrt(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *sqrt(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.sqrt)


def exp(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *exp(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.exp)


def soft_plus(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *softplus(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.softplus)


def factorial(x) -> Union[Tensor, PhiTreeNode]:
    """
    Computes *factorial(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`.
...
def log_gamma(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *log(gamma(x))* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
...
def to_float(x) -> Union[Tensor, PhiTreeNode]:
    ...
    See the `unifyml.math` module documentation at https://holl-.github.io/UnifyML/Math.html

    See Also:
        `cast()`.

    Args:
        x: `Tensor` or `unifyml.math.magic.PhiTreeNode` to convert
...
def to_int32(x) -> Union[Tensor, PhiTreeNode]:
    """ Converts the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x` to 32-bit integer. """
    return _backend_op1(x, Backend.to_int32)


def to_int64(x) -> Union[Tensor, PhiTreeNode]:
    """ Converts the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x` to 64-bit integer. """
...
def is_finite(x) -> Union[Tensor, PhiTreeNode]:
    """ Returns a `Tensor` or `unifyml.math.magic.PhiTreeNode` matching `x` with values `True` where `x` has a finite value and `False` otherwise. """
    return _backend_op1(x, Backend.isfinite)


def is_nan(x) -> Union[Tensor, PhiTreeNode]:
    """ Returns a `Tensor` or `unifyml.math.magic.PhiTreeNode` matching `x` with values `True` where `x` is `NaN` and `False` otherwise. """
    return _backend_op1(x, Backend.isnan)


def is_inf(x) -> Union[Tensor, PhiTreeNode]:
    """ Returns a `Tensor` or `unifyml.math.magic.PhiTreeNode` matching `x` with values `True` where `x` is `+inf` or `-inf` and `False` otherwise. """
    return _backend_op1(x, Backend.isnan)
...
def real(x) -> Union[Tensor, PhiTreeNode]:
    ...
    Args:
        x: `Tensor` or `unifyml.math.magic.PhiTreeNode` or native tensor.
...
def conjugate(x) -> Union[Tensor, PhiTreeNode]:
    ...
    Args:
        x: Real or complex `Tensor` or `unifyml.math.magic.PhiTreeNode` or native tensor.
...
def sin(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *sin(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.sin)


def arcsin(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes the inverse of *sin(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`.
...
def cos(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *cos(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.cos)


def arccos(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes the inverse of *cos(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`.
...
def tan(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *tan(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.tan)


def arctan(x, divide_by=None) -> Union[Tensor, PhiTreeNode]:
    """
    Computes the inverse of *tan(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`.
...
def sinh(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *sinh(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.sinh)


def arcsinh(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes the inverse of *sinh(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.arcsinh)


def cosh(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *cosh(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.cosh)


def arccosh(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes the inverse of *cosh(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.arccosh)


def tanh(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *tanh(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.tanh)


def arctanh(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes the inverse of *tanh(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.arctanh)


def log(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes the natural logarithm of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
    return _backend_op1(x, Backend.log)


def log2(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *log(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x` with base 2. """
    return _backend_op1(x, Backend.log2)


def log10(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes *log(x)* of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x` with base 10. """
    return _backend_op1(x, Backend.log10)


def sigmoid(x) -> Union[Tensor, PhiTreeNode]:
    """ Computes the sigmoid function of the `Tensor` or `unifyml.math.magic.PhiTreeNode` `x`. """
...
def stop_gradient(x):
    ...
    * Jax: [`jax.lax.stop_gradient`](https://jax.readthedocs.io/en/latest/_autosummary/jax.lax.stop_gradient.html)
    ...
    Args:
        x: `Tensor` or `unifyml.math.magic.PhiTreeNode` for which gradients should be disabled.
